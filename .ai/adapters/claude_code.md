...
Use this adapter to map project governance files into Claude Code-compatible working instructions.
...
Do not bypass the router layer. Claude Code-compatible instructions should classify the task and estimate risk before selecting workflow material.
